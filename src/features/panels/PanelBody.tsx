...
export function PanelBody({
  ...
  if (panel.type === 'ai') {
    return (
      <PanelFocusFrame isActive={isActive} onActivate={onActivate}>
        <div className="ai-panel flex h-full min-h-0 flex-col justify-between gap-5 overflow-auto p-4">
  ...
  if (panel.type === 'rdp') {
    return (
      <PanelFocusFrame isActive={isActive} onActivate={onActivate}>
        <div className="grid h-full min-h-0 place-content-center gap-3 overflow-auto bg-card p-4 text-center text-muted-foreground">
  ...
  return (
    <PanelFocusFrame isActive={isActive} onActivate={onActivate}>
      <div className="file-panel grid h-full min-h-0 content-start gap-1 overflow-auto p-3 text-sm">
        {[
          ['/var/www', 'remote path'],
          ['app', 'folder'],
          ['logs', 'folder'],
...
function LocalTerminalPlaceholder() {
  return (
    <div className="terminal-panel flex h-full min-h-0 flex-col overflow-auto p-4 font-mono text-[13px] leading-6">
...
export function LogsPanel({
  ...
  return (
    <PanelFocusFrame isActive={isActive} onActivate={onActivate}>
      <div className="terminal-panel h-full overflow-auto p-3 font-mono text-xs leading-5 text-muted-foreground">
        <div>
